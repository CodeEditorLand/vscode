	...
	const bundleAsync = async () => {
		...
		for (const entryPoint of entryPoints) {
			...
			if (!opts.skipTSBoilerplateRemoval?.(entryPoint.name)) {
				...
				banner.js += await fs_1.default.promises.readFile(
					tslibPath,
					"utf-8",
				);
			}
...
function minifyTask(src, sourceMapBaseUrl) {
	...
	return (cb) => {
		...
		const jsFilter = (0, gulp_filter_1.default)("**/*.js", {
			restore: true,
		});
		const cssFilter = (0, gulp_filter_1.default)("**/*.css", {
			restore: true,
		});
		const svgFilter = (0, gulp_filter_1.default)("**/*.svg", {
			restore: true,
		});
		(0, pump_1.default)(
