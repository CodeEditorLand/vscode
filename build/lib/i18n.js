...
function log(message, ...rest) {
	(0, fancy_log_1.default)(
		ansi_colors_1.default.green("[i18n]"),
		message,
		...rest,
	);
}
...
function processCoreBundleFormat(base, fileHeader, languages, json, emitter) {
	const languageDirectory = path_1.default.join(
		REPO_ROOT_PATH,
		"..",
		"vscode-loc",
		"i18n",
	...
	sortedLanguages.forEach((language) => {
		...
		const i18nFile = path_1.default.join(
			languageDirectory,
		...
		if (fs_1.default.existsSync(i18nFile)) {
			const content = stripComments(
				fs_1.default.readFileSync(i18nFile, "utf8"),
			);
...
function createXlfFilesForExtensions() {
	...
	return (0, event_stream_1.through)(
		function (extensionFolder) {
			...
			const extensionFolderName = path_1.default.basename(
			...
			const manifest = fs_1.default.readFileSync(
				path_1.default.join(extensionFolder.path, "package.json"),
				"utf-8",
			);
...
function prepareI18nPackFiles(resultingTranslationPaths) {
	...
	return (0, event_stream_1.through)(
		function (xlf) {
			let project = path_1.default.basename(
				path_1.default.dirname(path_1.default.dirname(xlf.relative)),
			);
			// strip `-new` since vscode-extensions-loc uses the `-new` suffix to indicate that it's from the new loc pipeline
			const resource = path_1.default.basename(
				path_1.default.basename(xlf.relative, ".xlf"),
				"-new",
			);
...
function createIslFile(name, messages, language, innoSetup) {
	...
	if (path_1.default.basename(name) === "Default") {
		originalContent = new TextModel(
			fs_1.default.readFileSync(name + ".isl", "utf8"),
		);
	} else {
		originalContent = new TextModel(
			fs_1.default.readFileSync(name + ".en.isl", "utf8"),
		);
	}
	...
	const encoded = iconv_lite_umd_1.default.encode(
