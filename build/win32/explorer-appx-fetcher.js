...
async function downloadExplorerAppx(
	...
	if (
		await fs_1.default.existsSync(
			path_1.default.resolve(outDir, "resources.pri"),
		)
	) {
		return;
	}
	...
	await (0, extract_zip_1.default)(artifact, {
		dir: fs_1.default.realpathSync(outDir),
	});
}
async function main(outputDir) {
	...
	const product = JSON.parse(
		fs_1.default.readFileSync(
			path_1.default.join(root, "product.json"),
			"utf8",
		),
	);
