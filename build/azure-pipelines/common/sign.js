...
class Temp {
	...
	tmpNameSync() {
		const file = path_1.default.join(
			os_1.default.tmpdir(),
			crypto_1.default.randomBytes(20).toString("hex"),
		);
...
function main([esrpCliPath, type, folderPath, pattern]) {
	...
	const dotnetVersion = child_process_1.default
		.execSync("dotnet --version", { encoding: "utf8" })
		.trim();
	const adoTaskVersion = path_1.default.basename(
		path_1.default.dirname(path_1.default.dirname(esrpCliPath)),
	);
	...
	try {
		child_process_1.default.execFileSync("dotnet", args, {
			stdio: "inherit",
		});
	} catch (err) {
