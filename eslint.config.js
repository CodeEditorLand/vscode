		...
		rules: {
			...
			"no-restricted-syntax": [
				"warn",
				{
					...
					"message":
						"Use DOM.isMouseEvent() to support multi-window scenarios.",
				},
				{
				...
				},
				{
					...
					"message":
						"Use DOM.isDragEvent() to support multi-window scenarios.",
				},
				{
	...
	},
	{
		...
		rules: {
			"local/code-import-patterns": [
				...
				{
					"target":
						"src/vs/{loader.d.ts,monaco.d.ts,nls.ts,nls.messages.ts}",
					"restrictions": [],
				},
				{
